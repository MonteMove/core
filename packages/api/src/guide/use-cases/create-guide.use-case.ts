...
export class CreateGuideUseCase {
    ...
    public async execute(createGuideDto: CreateGuideDto, userId: string): Promise<CreateGuideOutput> {
        const { description, fullName, phone, cardNumber, birthDate, address } = createGuideDto;
