...
export class GuideController {
    ...
    @ApiResponse({ status: 201, description: 'Гайд успешно создан', type: CreateGuideResponseDto })
    @ApiCrudResponses()
    ...
    @ApiResponse({ status: 200, description: 'Список гайдов успешно получен', type: GetGuidesResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 200, description: 'Гайд найден', type: GuideResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 200, description: 'Гайд успешно обновлён', type: UpdateGuideResponseDto })
    @ApiCrudResponses()
    ...
    @ApiIdParam('Уникальный идентификатор гайда')
    @ApiResponse({ status: 200, description: 'Гайд успешно удалён', type: DeleteGuideResponseDto })
    @ApiReadResponses()
