...
export class WalletTypeController {
  ...
  @ApiOperation({
    ...
    description:
      'Обновляет существующий тип кошелька. Доступно только администраторам.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Удаляет тип кошелька (мягкое удаление). Доступно только администраторам.',
  })
  @ApiResponse({
    status: 200,
  ...
  public async deleteWalletType(
    @Param('id') id: string,
  ): Promise<DeleteWalletTypeResponseDto> {
