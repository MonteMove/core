...
export class AuthUserResponseDto {
    ...
    @ApiProperty({ description: 'Telegram ID', example: '123456789', nullable: true })
    ...
    @ApiProperty({ description: 'Последний вход', example: '2024-01-01T00:00:00.000Z', nullable: true })
...
export class LoginResponseDto {
    ...
    @ApiProperty({ description: 'Информация о пользователе', type: AuthUserResponseDto })
    public user: AuthUserResponseDto;

    @ApiProperty({ description: 'Сообщение о результате', example: 'Успешный вход в систему' })
