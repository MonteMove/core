...
export class CurrencyController {
    ...
    @ApiResponse({ status: 201, description: 'Валюта успешно создана', type: CreateCurrencyResponseDto })
    @ApiCrudResponses()
    ...
    @ApiResponse({ status: 200, description: 'Список валют успешно получен', type: GetCurrenciesResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 200, description: 'Валюта найдена', type: CurrencyResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 200, description: 'Валюта успешно обновлена', type: UpdateCurrencyResponseDto })
    @ApiCrudResponses()
    ...
    @ApiIdParam('Уникальный идентификатор валюты')
    @ApiResponse({ status: 200, description: 'Валюта успешно удалена', type: DeleteCurrencyResponseDto })
    @ApiReadResponses()
