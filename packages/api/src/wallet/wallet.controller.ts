...
export class WalletController {
  ...
  @ApiOperation({
    ...
    description:
      'Возвращает информацию о конкретном кошельке. Доступно только администраторам.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Создаёт новый кошелек в системе. Доступно только администраторам.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Обновляет данные существующего кошелька. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор кошелька')
  ...
  public async updateWallet(
    ...
    const result = await this.updateWalletUseCase.execute(
      walletId,
      updateWalletDto,
      userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Изменяет параметры закрепления кошелька (pinned, pinOnMain). Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор кошелька')
  ...
  public async toggleWalletPin(
    ...
    const result = await this.toggleWalletPinUseCase.execute(
      walletId,
      toggleWalletPinDto,
      userId,
    );
  ...
  public async changeWalletOwner(
    ...
    const result = await this.changeWalletOwnerUseCase.execute(
      walletId,
      changeWalletOwnerDto,
      userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Выполняет мягкое удаление кошелька из системы. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор кошелька')
  @ApiResponse({
    status: 200,
