...
export class UserController {
  ...
  @ApiOperation({
    ...
    description:
      'Заменяет список ролей пользователя на указанный. Доступно только администраторам.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Возвращает информацию о конкретном пользователе. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор пользователя')
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Обновляет данные существующего пользователя. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор пользователя')
  ...
  @ApiOperation({
    ...
    description:
      'Изменяет статус блокировки пользователя. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор пользователя')
  ...
  @ApiOperation({
    ...
    description:
      'Выполняет мягкое удаление пользователя из системы. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор пользователя')
  @ApiResponse({
    status: 200,
