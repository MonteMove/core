...
export class ApplicationController {
    ...
    @ApiResponse({ status: 200, description: 'Список заявок успешно получен', type: GetApplicationsResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 200, description: 'Заявка найдена', type: ApplicationResponseDto })
    @ApiReadResponses()
    ...
    @ApiResponse({ status: 201, description: 'Заявка успешно создана', type: CreateApplicationResponseDto })
    @ApiCrudResponses()
    ...
    @ApiResponse({ status: 200, description: 'Заявка успешно обновлена', type: UpdateApplicationResponseDto })
    @ApiCrudResponses()
    ...
    @ApiIdParam('Уникальный идентификатор заявки')
    @ApiResponse({ status: 200, description: 'Заявка успешно удалена', type: DeleteApplicationResponseDto })
    @ApiReadResponses()
