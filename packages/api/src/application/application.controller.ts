...
export class ApplicationController {
  ...
  public async getApplications(
    ...
    const result =
      await this.getApplicationsUseCase.execute(getApplicationsDto);
  ...
  @ApiOperation({
    ...
    description:
      'Возвращает информацию о конкретной заявке. Доступно только администраторам.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Создаёт новую заявку в системе. Доступно только администраторам.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Обновляет данные существующей заявки. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор заявки')
  ...
  @ApiOperation({
    ...
    description:
      'Выполняет мягкое удаление заявки из системы. Доступно только администраторам.',
  })
  @ApiIdParam('Уникальный идентификатор заявки')
  @ApiResponse({
    status: 200,
  ...
  public async deleteApplication(
    ...
    const result = await this.deleteApplicationUseCase.execute(
      applicationId,
      userId,
    );
