...
export class AnalyticsService {
  ...
  public static async getAnalyticsById(id: string): Promise<AnalyticsItemResponse> {
    const response = await axiosInstance.get(API_MAP.ANALYTICS.ANALYTICS_BY_ID(id));
